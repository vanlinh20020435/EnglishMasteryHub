...
import com.emh.security.jwt.AuthEntryPointJwt;
import com.emh.security.jwt.AuthTokenFilter;
...
public class SecurityConfig
{
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception
	{
		...
		http.httpBasic(Customizer.withDefaults())
				...
				.authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests.requestMatchers("/**").permitAll().anyRequest().authenticated());
